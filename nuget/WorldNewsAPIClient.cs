...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/news";
        ...
        {
            { "category", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public WorldNewsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WorldNewsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WorldNewsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WorldNewsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WorldNewsQueryOptions options)
        {
        ...
        public ResponseObj Execute(WorldNewsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WorldNewsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WorldNewsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WorldNewsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WorldNewsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WorldNewsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WorldNewsQueryOptions options)
        {
