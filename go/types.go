...
// Request contains the parameters for the World News API.
//
// Parameters:
...
// ResponseData contains the data returned by the World News API.
...
// ArticlesItem represents an item in the Articles array.
