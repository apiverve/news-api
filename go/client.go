// Package news provides a Go client for the World News API.
//
// For more information, visit: https://apiverve.com/marketplace/news?utm_source=go&utm_medium=readme
package news
...
const (
	baseURL        = "https://api.apiverve.com/v1/news"
	defaultTimeout = 30 * time.Second
)

// Client is the World News API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new World News API client.
...
// Execute makes a request to the World News API with typed parameters.
//
...
//   - category (required): string - The news category for which you want to get the news. Allowed values: business, entertainment, world, health, science, sports, technology
