...
```gradle
dependencies {
    implementation 'com.github.apiverve:news-api:1.1.14'
}
```
...
```java
import com.apiverve.news.WorldNewsAPIClient;
import com.apiverve.news.APIResponse;
import com.apiverve.news.APIException;

// Initialize the client
WorldNewsAPIClient client = new WorldNewsAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("category", "technology");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/news](https://docs.apiverve.com/ref/news)
...
- **Documentation:** [https://docs.apiverve.com/ref/news](https://docs.apiverve.com/ref/news)
- **Issues:** [GitHub Issues](https://github.com/apiverve/news-api/issues)
